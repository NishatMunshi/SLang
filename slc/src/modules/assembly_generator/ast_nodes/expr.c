...
string *assembly_generator_generate_expr(ast_node_expr *node_expr) {
    switch (ast_node_expr_get_type(node_expr)) {
        case AST_NODE_EXPR_UN_EXPR:
            return assembly_generator_generate_un_expr(ast_node_expr_get_un_expr(node_expr));
        case AST_NODE_EXPR_BIN_EXPR:
            return assembly_generator_generate_bin_expr(ast_node_expr_get_bin_expr(node_expr));
